...
function addSet(buttonElement) {
    ...
    newRow.innerHTML = `
        <td>${setNumber}</td>
        <td><input type="text" id="login" class="styled-input" name="login" /></td>
    ...
    exerciseContainer.innerHTML = `
        <div class="exercise-container">
            <div class="exercise-header">
                <input type="text" class="exercise-title styled-input" placeholder="Прием пищи..." />
            ...
            <div class="exercise-card">
                ...
                <button type="button" class="btn-custom" onclick="addSet(this)">Добавить еду</button>
                <button type="button" class="btn-custom btn-delete-exercise" onclick="removeExercise(this)" style="background-color: #8b0000; margin-left: 10px;">Удалить проем пищи</button>
            </div>
        </div>
    `;
